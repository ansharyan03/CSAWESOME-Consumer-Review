 ...
 */
  public static double totalSentiment(String filename)
  {
    ...
    String newString = textToString(filename);
    ...
    //TRY THIS WITH A SCANNER AND DELIMITER
    Scanner words = new Scanner(newString);
    String temp = "";
    while(words.hasNext())
    {
      temp = words.next();
      sentimentTotal += sentimentVal(removePunctuation(temp));
      //System.out.println(temp);
    }
    words.close();
  ...
  */
  ...
  public static String fakeReview(String filename){ // makes it positive
    String finalString = "";
    String temp = "";
    String review = textToString(filename);
    Scanner stringScanner = new Scanner(review);
    while(stringScanner.hasNext()) {
      temp = stringScanner.next();
      if (temp.charAt(0) == '*' && sentimentVal(removePunctuation(temp)) <= 0) {
        temp = randomPositiveAdj() + getPunctuation(temp);
      }
      if(temp.charAt(0) == '*')
      {
